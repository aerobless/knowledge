...
* Understanding the domain & core use cases.
  * Priorities requirements and NFRs and pick the most important ones for an MVP
* Draw a data flow diagram that shows the interactions between the user and all required systems for the core use cases.
* Draw a high level system diagram that shows all the required systems.
* Draw a domain model to establish a vocabulary that can be used with the client. This also ensures that you've understood the problem domain correctly and that you can communicate with stakeholders effectively.
