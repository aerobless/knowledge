...
* [Eleven Labs Reader](https://elevenlabs.io/text-reader): [iOS app](operating-systems/ios.md#useful-apps) that can read from text, url, pdf or ePub documents with various narration voices. Works amazingly well with a very high quality narration that feels like it’s from a professional audiobook narrator.
